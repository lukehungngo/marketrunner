"""
Django settings for marketrunner project.
...
SECRET_KEY = "django-insecure-picdl+d$2u1wpgbzu6)j4b%%^b_rwy=@k-@)%ajpy0xi*w+)a&"
...
WSGI_APPLICATION = "marketrunner.wsgi.application"
